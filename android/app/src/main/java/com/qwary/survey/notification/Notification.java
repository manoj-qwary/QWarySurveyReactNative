...
public class Notification {
    ...
    public static class NotificationEntry implements BaseColumns{
        ...
        public static final String NOTIFICATION_TOKEN_TEXT = "token";
        public static final String NOTIFICATION_LOADER_TEXT = "loader";
        public static final String NOTIFICATION_MODAL_TEXT = "modal";
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + NotificationEntry.TABLE_NAME + " (" +
                    ...
                    NotificationEntry.NOTIFICATION_TOKEN_TEXT + " TEXT," +
                    NotificationEntry.NOTIFICATION_LOADER_TEXT + " INTEGER," +
                    NotificationEntry.NOTIFICATION_MODAL_TEXT + " INTEGER," +
